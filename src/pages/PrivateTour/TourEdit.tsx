                    ...
                    <div className="bg-white p-6 rounded-lg border border-gray-200">
                        ...
                        <div className="space-y-6">
                            ...
                            <FileUpload
                                ...
                                description="Upload new poster image to replace current one (Optional, Max 5MB)"
                                showPreview={true}
                            ...
                            <FileUpload
                                ...
                                description="Upload new VR image to replace current one (Optional, Max 5MB)"
                                showPreview={true}
                            ...
                            <FileUpload
                                ...
                                description="Upload new tour images to replace current ones (Optional, Max 10 files, 5MB each)"
