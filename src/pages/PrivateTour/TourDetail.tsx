...
export default function TourDetail() {
    ...
    const {
        ...
        queryKey: [QUERY_KEYS.privateTour.all, id],
    ...
    const handleEdit = () => {
        navigate(paths.PRIVATE_TOUR.EDIT(id));
    };
            ...
            <div className="bg-white border-b border-gray-200">
                <div className="max-w-7xl mx-auto px-6 py-6">
                    <div className="flex items-center justify-between">
                        ...
                        <button
                            onClick={handleEdit}
                            className="inline-flex items-center px-6 py-3 text-white rounded-lg bg-gradient-to-r from-primary to-tab hover:from-primary hover:to-tab cursor-pointer transition-colors font-medium"
                        >
                            <svg
                                className="w-5 h-5 mr-2"
                                fill="none"
