...
const schema = yup.object({
  ...
  order: yup.string().required("Order is required").min(0, "Order must be at least 0"),
  name: yup.string().required("Tour name is required").min(2, "Name must be at least 2 characters"),
  googlemapurl: yup.string().url("Must be a valid URL").required("Google Map URL is required"),
  ...
  tourprograms: yup.array().of(yup.string().required()).min(1, "At least one tour program is required").required(),
  ...
  posterimagefile: yup.mixed<File>().required("Poster image is required").nullable(),
